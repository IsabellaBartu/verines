...
class RestaurantView:
    ...
    def draw_tables(self, screen):
        table_positions = [(500, 230), (850, 230)]
    ...
    def draw_window(self, screen):
        pygame.draw.rect(screen, (180, 220, 255), (930, 60, 250, 140), border_radius=15)
        pygame.draw.rect(screen, BROWN, (930, 60, 250, 140), 5, border_radius=15)
    ...
    def draw_lights(self, screen):
        pygame.draw.circle(screen, (255, 220, 120), (250, 80), 40)
        pygame.draw.circle(screen, (255, 220, 120), (650, 80), 40)

    def draw_customer(self, screen):
        pygame.draw.circle(screen, (240, 220, 190), (220, 420), 60)
        pygame.draw.rect(screen, (120, 70, 50), (170, 480, 100, 140), border_radius=20)
